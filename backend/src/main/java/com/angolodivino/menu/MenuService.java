    ...
    public List<MenuSectionResponse> findMenuSections() {
        return List.of(
                ...
                new MenuSectionResponse(
                        ...
                        List.of(
                                // Pre-Dinner (6/7 euro)
                                new MenuItemResponse("americano", "Americano", "Pre-Dinner", "(Vermouth Rosso, Campari, Soda)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("bellini", "Bellini", "Pre-Dinner", "(Prosecco, Succo di pesca)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("garibaldi", "Garibaldi", "Pre-Dinner", "(Campari, Succo d'Arancia)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("negroni", "Negroni", "Pre-Dinner", "(gin, Vermouth rosso, Campari, Fetta d'arancia)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("negroni_sbagliato", "Negroni Sbagliato", "Pre-Dinner", "(Vermouth rosso, Campari, prosecco, Fetta d'arancia)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("martini_cocktail", "Martini Cocktail", "Pre-Dinner", "(Gin, Vermouth Dry, scorza di lime, olive)", List.of(), "6 € / 7 €"),
                                ...
                                new MenuItemResponse("kir_royale", "Kir Royale", "Pre-Dinner", "(prosecco, Crème de Cassis)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("rossini", "Rossini", "Pre-Dinner", "(Prosecco, Fragola)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("aperol_spritz", "Aperol Spritz", "Pre-Dinner", "(Prosecco, Aperol, Soda, fetta d'arancia)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("campari_spritz", "Campari Spritz", "Pre-Dinner", "(Prosecco, Campari, Soda, fetta d'arancia)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("manhattan", "Manhattan", "Pre-Dinner", "(rye whiskey, vermouth rosso, angostura, ciliegina)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("dry_manhattan", "Dry Manhattan", "Pre-Dinner", "(rye whiskey, vermouth dry, angostura, buccia di limone)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("perfect_manhattan", "Perfect Manhattan", "Pre-Dinner", "(rye whiskey, vermouth rosso, vermouth dry, ciliegina)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("rob_roy", "Rob Roy", "Pre-Dinner", "(Scotch whisky, vermouth rosso, angostura, ciliegina)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("dry_martini", "Dry Martini", "Pre-Dinner / Martini Cocktails", "(gin, vermouth dry, sprizzo di buccia di limone)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("vodka_martini", "Vodka Martini", "Pre-Dinner / Martini Cocktails", "(vodka, vermouth dry, sprizzo di buccia di limone)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("sweet_martini", "Sweet Martini", "Pre-Dinner / Martini Cocktails", "(gin, vermouth rosso, ciliegina)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("perfect_martini", "Perfect Martini", "Pre-Dinner / Martini Cocktails", "(gin, vermouth rosso, vermouth dry, ciliegina)", List.of(), "6 € / 7 €"),
                                ...
                                new MenuItemResponse("daiquiri", "Daiquiri", "After Dinner", "(Rum, Succo di limone o lime, Sciroppo di zucchero)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("french_connection", "French connection", "After Dinner", "(Cognac, Disaronno)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("mexican_passion", "Mexican passion", "After Dinner", "(tequila blanco, triple sec, succo di lime, succo di passion fruit, fetta di limone)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("gin_fizz", "Gin Fizz", "After Dinner", "(Gin, Succo di limone, Sciroppo di zucchero, Soda water)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("godfather", "Godfather", "After Dinner", "(Whisky, Disaronno)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("godmother", "Godmother", "After Dinner", "(Vodka, Disaronno)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("kamikaze", "Kamikaze", "After Dinner", "(vodka, triple sec, succo di limone)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("whitelady", "Whitelady", "After Dinner", "(Gin, Triple Sec, Succo di limone)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("limbo", "Limbo", "After Dinner", "(Rum bianco, Creme de banana, Succo d'arancia)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("margarita", "Margarita", "After Dinner", "(Tequila, Triple Sec, Succo di limone o lime)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("orgasm", "Orgasm", "After Dinner", "(Baileys, Amaretto, Kahlua)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("melon_ball", "Melon ball", "After Dinner", "(Midori, Vodka, Succo d'arancia)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("paradise", "Paradise", "After Dinner", "(Gin, Apricot brandy, Succo d'arancia)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("rusty_nail", "Rusty nail", "After Dinner", "(Scotch whisky, Drambuie)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("sidecar", "Sidecar", "After Dinner", "(Cognac, Triple sec o Cointreau, Succo di limone)", List.of(), "6 € / 7 €"),
                                ...
                                new MenuItemResponse("lynchburg_lemonade", "Lynchburg lemonade", "Long Drinks", "(jack Daniel's, triple sec, succo di limone, sprite)", List.of(), "6 €"),
                                new MenuItemResponse("pina_colada", "Pina colada", "Long Drinks", "(Rum, Crema di cocco, Ananas)", List.of(), "6 €"),
                                new MenuItemResponse("pina_colada_varianti", "Varianti di Pina Colada", "Long Drinks", "", List.of(), "6 €"),
                                ...
                                new MenuItemResponse("caipiroska", "Caipiroska", "Pestati e Frozen", "(Vodka, Lime, Zucchero di canna)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("strawberry_caipiroska", "Strawberry caipiroska", "Pestati e Frozen", "(Vodka, Lime, Zucchero di canna, Fragola)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("caipirissima", "Caipirissima", "Pestati e Frozen", "(Rum, Lime, Zucchero di canna)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("caipiriteqa", "Caipiriteqa", "Pestati e Frozen", "(Tequila, Lime, Zucchero di canna)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("mojito", "Mojito", "Pestati e Frozen", "(Rum, Lime, Foglie di menta, Watersoda)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("frozen_slammer", "Frozen slammer", "Pestati e Frozen", "(Southern comfort, Disaronno, Fragola, Sciroppo e frutta)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("frozen_daiquiri", "Frozen daiquiri", "Pestati e Frozen", "(Rum, Fragola, Banana, Ananas, ecc, Sweet & Sour)", List.of(), "6 € / 7 €"),
                                new MenuItemResponse("frozen_margarita", "Frozen margarita", "Pestati e Frozen", "(Tequila, Fragola, Banana, Ananas, ecc, Sweet & Sour)", List.of(), "6 € / 7 €")
                        )
                ),
                new MenuSectionResponse(
                        "vini",
