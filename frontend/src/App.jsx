...
const fallbackMenuSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'negroni', name: 'Negroni', subtitle: 'Pre-Dinner', description: '(gin, Vermouth rosso, Campari, Fetta d\'arancia)', notes: [], price: '6 € / 7 €' },
      { id: 'negroni_sbagliato', name: 'Negroni Sbagliato', subtitle: 'Pre-Dinner', description: '(Vermouth rosso, Campari, prosecco, Fetta d\'arancia)', notes: [], price: '6 € / 7 €' },
      { id: 'martini_cocktail', name: 'Martini Cocktail', subtitle: 'Pre-Dinner', description: '(Gin, Vermouth Dry, scorza di lime, olive)', notes: [], price: '6 € / 7 €' },
      ...
      { id: 'kir_royale', name: 'Kir Royale', subtitle: 'Pre-Dinner', description: '(prosecco, Crème de Cassis)', notes: [], price: '6 € / 7 €' },
      { id: 'rossini', name: 'Rossini', subtitle: 'Pre-Dinner', description: '(Prosecco, Fragola)', notes: [], price: '6 € / 7 €' },
      { id: 'aperol_spritz', name: 'Aperol Spritz', subtitle: 'Pre-Dinner', description: '(Prosecco, Aperol, Soda, fetta d\'arancia)', notes: [], price: '6 € / 7 €' },
      { id: 'campari_spritz', name: 'Campari Spritz', subtitle: 'Pre-Dinner', description: '(Prosecco, Campari, Soda, fetta d\'arancia)', notes: [], price: '6 € / 7 €' },
      ...
      { id: 'dry_manhattan', name: 'Dry Manhattan', subtitle: 'Pre-Dinner', description: '(rye whiskey, vermouth dry, angostura, buccia di limone)', notes: [], price: '6 € / 7 €' },
      { id: 'perfect_manhattan', name: 'Perfect Manhattan', subtitle: 'Pre-Dinner', description: '(rye whiskey, vermouth rosso, vermouth dry, ciliegina)', notes: [], price: '6 € / 7 €' },
      { id: 'rob_roy', name: 'Rob Roy', subtitle: 'Pre-Dinner', description: '(Scotch whisky, vermouth rosso, angostura, ciliegina)', notes: [], price: '6 € / 7 €' },
      { id: 'dry_martini', name: 'Dry Martini', subtitle: 'Pre-Dinner / Martini Cocktails', description: '(gin, vermouth dry, sprizzo di buccia di limone)', notes: [], price: '6 € / 7 €' },
      { id: 'vodka_martini', name: 'Vodka Martini', subtitle: 'Pre-Dinner / Martini Cocktails', description: '(vodka, vermouth dry, sprizzo di buccia di limone)', notes: [], price: '6 € / 7 €' },
      { id: 'sweet_martini', name: 'Sweet Martini', subtitle: 'Pre-Dinner / Martini Cocktails', description: '(gin, vermouth rosso, ciliegina)', notes: [], price: '6 € / 7 €' },
      { id: 'perfect_martini', name: 'Perfect Martini', subtitle: 'Pre-Dinner / Martini Cocktails', description: '(gin, vermouth rosso, vermouth dry, ciliegina)', notes: [], price: '6 € / 7 €' },
      ...
      { id: 'mexican_passion', name: 'Mexican passion', subtitle: 'After Dinner', description: '(tequila blanco, triple sec, succo di lime, succo di passion fruit, fetta di limone)', notes: [], price: '6 € / 7 €' },
      ...
      { id: 'lynchburg_lemonade', name: 'Lynchburg lemonade', subtitle: 'Long Drinks', description: '(jack Daniel\'s, triple sec, succo di limone, sprite)', notes: [], price: '6 €' },
